...
const PremiumProducts = () => {
  return (
    <div className="my-20 container mx-auto">
      <h3 className="font-bold py-6 text-md">Our New Product Launch</h3>
      <div className="card w-10/12 course_details flex justify-between mx-auto bg-base-100 shadow-sm border border-gray-400 mt-8 rounded-xl">
        <div className="flex justify-center items-center">
          <img src={test} alt="/" className="lg:w-7/12 md:h-96" />
        </div>
        <div className="card-body pl-8 py-6 text-black">
          ...
          <p>
            Price :850000 <small></small>
          </p>
          <p className="font-medium pr-2">
            Condition: Good<small></small>
          </p>
          <p className="font-medium py-2">
            Description: Mazda Motor Corporation commonly referred to as simply
            Mazda, is a Japanese multinational automotive<small></small>
          </p>
          <p className="font-medium py-2">
          ...
          <Link to={`/checkout/`}>
            <PrimaryButton>Get Details</PrimaryButton>
          </Link>
        </div>
      </div>
    </div>
